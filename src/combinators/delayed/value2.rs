...
impl<D1, D2> DelayedValGetTuple for (D1, D2)
where
    D1: DelayedValGet,
    D2: DelayedValGet,
{
    type Values = (D1::Value, D2::Value);
    type Ref<'a>
        = (Ref<'a, D1::Value>, Ref<'a, D2::Value>)
    where
        D1: 'a,
        D2: 'a;
...
pub trait DelayedValSetTuple {
    type Values;

    fn set(&self, values: Self::Values);
}

impl<D1, D2> DelayedValSetTuple for (D1, D2)
where
    D1: DelayedValSet,
    D2: DelayedValSet,
{
